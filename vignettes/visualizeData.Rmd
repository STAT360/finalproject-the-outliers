...
num_discharges_heart<-createMap(StateVsNumProcedures, numberOfDischarges, "Number of heart transplants", "Number of Heart Transplants by State",'To visualize the frequency of the most expensive procedure.')
